...
// all requests for a period of time before slowly allowing a few.
//
// Circuit breakers start in the StateStandby first, observing errors and watching metrics.
//
// Once the Circuit breaker condition is met, it enters the StateTripped, where it blocks all traffic and returns
...
//
//    allowedRequestsRatio = 0.5 * (Now() - StartRecovery())/Config.RecoveryPeriod
//
